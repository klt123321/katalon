...
'第一次删除标签'
WebUI.click(findTestObject('删除业务模型/Page_Zetta Decision/svg - Copy'))

WebUI.click(findTestObject('Object Repository/删除业务模型/Page_Zetta Decision/svg'))

WebUI.clickOffset(findTestObject('删除业务模型/Page_Zetta Decision/a__1'), 5, 5)

WebUI.clickOffset(findTestObject('删除业务模型/Page_Zetta Decision/span__1_2 - Copy'), 0, 0)
